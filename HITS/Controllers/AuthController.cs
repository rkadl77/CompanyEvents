    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel model)
        {
            ...
            try
            {
                ...
                {
                    return BadRequest(new { message = $"Ошибка регистрации: указанная роль '{model.Role}' недопустима." });
                }
            }
            catch
            {
            ...
            return Ok(new { message = "Пользователь успешно зарегистрирован. Ожидайте подтверждения администратором." });
        }
